...
return ( 
        ...
        <div className="header" id="navigation">
            <div className="header__nav">
                ...
                <a href="#projects"><p className="header__nav header__nav-hover"><span className="pink" >Project</span></p></a>
                <a href="#about_me"><p className="header__nav header__nav-hover">About Me</p></a>
                <a href="#message"><p className="header__nav border header__contact header__nav-hover">Contact</p></a>
            </div>
            <div className="header__nav">
